# Draft: `AGENTS.md` v0.1

**Status:** Updated local draft — promoted to the root `AGENTS.md` for the first continuity proof; awaiting the first checkpoint commit.
...
- Treat [Agent HQ / Agent OS — Architecture Baseline v0.2](Agent%20HQ%20-%20Agent%20OS%20%E2%80%94%20Architecture%20Baseline%20v0.2.md) as the implementation baseline and [CIEL Genesis Contract v0.2](CIEL_GENESIS_CONTRACT_v0.2.md) as the proposed authority/truth boundary. Surface any conflict; do not silently reconcile it.
